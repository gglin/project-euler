...
# Consider graphs built with the units A:  http://projecteuler.net/project/images/p_194_GraphA.png
# and B:  http://projecteuler.net/project/images/p_194_GraphB.png, where the units are glued along
# the vertical edges as in the graph  http://projecteuler.net/project/images/p_194_Fig.png.
# 
