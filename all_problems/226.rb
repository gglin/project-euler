...
# The blancmange curve is the set of points (x,y) such that 0 ≤ x ≤ 1 and  http://projecteuler.net/project/images/p_226_formula.gif ,where s(x) = the distance from x to the nearest integer.
# 
# The area under the blancmange curve is equal to ½, shown in pink in the diagram below.
# 
# 
#  http://projecteuler.net/project/images/p_226_scoop2.gif
# 
