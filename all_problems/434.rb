...
# 
# The grid graphs embedded in the Euclidean plane are not rigid, as the following animation demonstrates:http://projecteuler.net/project/images/p434_rigid.gif
# However, one can make them rigid by adding diagonal edges to the cells. For example, for the 2x3 grid graph, there are 19 ways to make the graph rigid:http://projecteuler.net/project/images/p434_rigid23.png
