...
# 
# Let Fk be the Fibonacci numbers: Fk = Fk-1 + Fk-2 with base cases F1 = F2 = 1.Find ∑1≤k≤30 C(10^12, √k, √Fk), and give your answer rounded to 8 decimal places behind the decimal point.
